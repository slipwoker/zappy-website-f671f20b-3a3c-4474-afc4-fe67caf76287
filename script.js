...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (animatedElements.length > 0) {
    ...
    function getObserverOptions(el) {
      return {
        threshold: parseFloat(el.dataset.animateThreshold) || defaultThreshold,
        rootMargin: el.dataset.animateRootMargin || defaultRootMargin,
      };
    }
    ...
    if ('IntersectionObserver' in window) {
      ...
      animatedElements.forEach(function (el) {
        ...
        const optionsKey = (el.dataset.animateThreshold || defaultThreshold) + '|' +
          (el.dataset.animateRootMargin || defaultRootMargin);

        if (!observerMap.has(optionsKey)) {
            ...
            entries.forEach(function (entry) {
              if (entry.isIntersecting) {
                ...
                setTimeout(function () {
                  ...
                  target.classList.remove('animate-ready');
                }, parseFloat(delay) * 1000);

                observer.unobserve(target);
              }
            });
          }, getObserverOptions(el));

          observerMap.set(optionsKey, observer);
        }

        observerMap.get(optionsKey).observe(el);
      });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f671f20b-3a3c-4474-afc4-fe67caf76287',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f671f20b-3a3c-4474-afc4-fe67caf76287';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f671f20b-3a3c-4474-afc4-fe67caf76287';
